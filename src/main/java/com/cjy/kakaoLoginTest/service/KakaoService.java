package com.cjy.kakaoLoginTest.service;
...
public class KakaoService {
	...
	public String getAccessToken(String authorize_code) {
		...
		try {
			...
			sb.append("&client_id=ba1b53f1a33228aace8ccb4b6f07e12b"); // 본인이 발급받은 key
			sb.append("&redirect_uri=http://localhost:8025/login"); // 본인이 설정해 놓은 경로
	...
	public HashMap<String, Object> getUserInfo(String access_Token) {
		...
		try {
			...
			//위에서 '"email_needs_agreement":true'값이 나온다면 kakao_account 객체 내에 "email" key값이 null이 되고맙니다.
